...
## This script pre select the mc DYJetsToLL
...
chain_in.Add
chain_in.Add("root://eoscms.cern.ch//eos/cms/store/group/phys_smp/ggNtuples/13TeV/mc/V07_04_16_03/job_spring15_DYJetsToLL_m50_miniAOD.root")
...
log.write("############################################################\n")
log.write("INPUT root://eoscms.cern.ch//eos/cms/store/group/phys_smp/ggNtuples/13TeV/mc/V07_04_16_03/job_spring15_DYJetsToLL_m50_miniAOD.root")


dd=datetime.datetime.now().strftime("%b%d")
os.system('mkdir -p ../preselected/Output_mcdyjets_'+dd)
os.chdir("../preselected/Output_mcdyjets_"+dd)

file_out = ROOT.TFile("reduced_mcdyjetstoll.root","recreate")
