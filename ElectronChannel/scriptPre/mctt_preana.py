...
## This script pre select the mctt
...
chain_in.Add
chain_in.Add("root://eoscms.cern.ch//eos/cms/store/group/phys_smp/ggNtuples/13TeV/mc/V07_04_16_03/job_spring15_TT_miniAOD.root")
...
log.write("############################################################\n")
log.write("INPUT root://eoscms.cern.ch//eos/cms/store/group/phys_smp/ggNtuples/13TeV/mc/V07_04_16_03/job_spring15_TT_miniAOD.root")


dd=datetime.datetime.now().strftime("%b%d")
os.system('mkdir -p ../preselected/Output_mctt_'+dd)
os.chdir("../preselected/Output_mctt_"+dd)

file_out = ROOT.TFile("reduced_mctt.root","recreate")
