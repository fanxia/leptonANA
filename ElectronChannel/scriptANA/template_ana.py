...
# The preselection part can be skip/commentout unless the preselect cuts changed. For any change of the selection cuts, should do this ana again
...
chain_in.Add("../preselected/XXXX_reduced_singleEle.root")
n_events = chain_in.GetEntries()
print"Total events for processing: ",n_events

os.system('mkdir -p ../selected/Output_Selected_data/bkg/signal')
os.chdir("../selected/Output_Selected_data/bkg/signal")
...
file_out = ROOT.TFile("selected_singleEle_xx.root","recreate")
