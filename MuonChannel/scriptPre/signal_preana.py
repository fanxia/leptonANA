...
## This script pre select the signal
...
chain_in.Add('file:~/work/private/ggntuples_sig600_375.root')
#chain_in.Add('file:~/work/private/stop600_bino350.root')
...
os.system('mkdir -p ../preselected/Output_sig600_375_'+dd)
os.chdir("../preselected/Output_sig600_375_"+dd)

file_out = ROOT.TFile("reduced_sig600_375.root","recreate")
