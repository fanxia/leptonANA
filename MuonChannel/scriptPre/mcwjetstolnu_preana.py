...
## This script pre select the job_spring15_WJetsToLNu_aMCatNLO_miniAOD.root
...
chain_in.Add("root://eoscms.cern.ch//eos/cms/store/group/phys_smp/ggNtuples/13TeV/mc/V07_04_16_03/job_spring15_WJetsToLNu_aMCatNLO_miniAOD.root")
...
file_out = ROOT.TFile("reduced_mcwjets.root","recreate")
...
log.write("############################################################\n")
log.write("INPUT root://eoscms.cern.ch//eos/cms/store/group/phys_smp/ggNtuples/13TeV/mc/V07_04_16_03/job_spring15_WJetsToLNu_aMCatNLO_miniAOD.root")
