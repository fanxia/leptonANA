...
SinglePhoHoE = ROOT.TH1F("SinglePhoHoE","",20,0,0.2)
SinglePhoSigmaIEtaIEta = ROOT.TH1F("SinglePhoSigmaIEtaIEta","",50,0,0.015)
SinglePhoSigmaIPhiIPhi = ROOT.TH1F("SinglePhoSigmaIPhiIPhi","",60,0,0.3)
...
SingleFakeSigmaIEtaIEta = ROOT.TH1F("SingleFakeSigmaIEtaIEta","",50,0,0.015)
SingleFakeSigmaIPhiIPhi = ROOT.TH1F("SingleFakeSigmaIPhiIPhi","",60,0,0.3)
...
#-------------------------below for signal region1 &2
    if chain_in.region==1:
        ...
        SinglePhoHoE.Fill(chain_in.phoHoverE[0],weight)
...
c.Clear()
SinglePhoHoE.Sumw2()
SinglePhoHoE.Draw("hist")
SinglePhoHoE.SetTitle(";#gamma_{H/E};N_events   ")
Header.Draw("same")
sr1Comment.Draw("same")
SinglePhoHoE.UseCurrentStyle()
c.Print(sys.argv[2]+".pdf")
...
SR1invmupho.SetTitle(";m_{#mu#gamma};N_events / GeV   ")
...
CR1invmufake.SetTitle(";m_{#mu,fake};N_events / GeV   ")
