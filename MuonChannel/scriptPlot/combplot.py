...
#------------pre plot
#--pfMET
#stack("Pre-selection_pfMET","pfMET","MET(GeV)","number of events",predata,"DataSingleMu",premcttw,"bkg_ttw",frac_ttw,premcttg,"bkg_ttg",frac_ttg,premcdyjets,"bkg_zjets",frac_dyjets,premcwjets,"bkg_wjets",frac_wjets,premctt,"bkg_tt",frac_tt)
#--nVtx
